...
public class SearchLibraryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        apiAddr = getResources().getString(R.string.api_library);
        ...
        lvPerformingplace.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(SearchLibraryActivity.this, CulartPlaceDetailActivity.class);
    ...
    class openapiAsyncTask extends AsyncTask<String, Integer, String> {
                ...
                protected void onPreExecute() {
                    super.onPreExecute();
                    progressDlg = ProgressDialog.show(SearchLibraryActivity.this, "Wait", "Downloading...");
        }
