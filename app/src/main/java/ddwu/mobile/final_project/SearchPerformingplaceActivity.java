...
public class SearchPerformingplaceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        apiAddr = getResources().getString(R.string.api_performingplace);
        ...
        lvPerformingplace.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(SearchPerformingplaceActivity.this, CulartPlaceDetailActivity.class);
    ...
    class openapiAsyncTask extends AsyncTask<String, Integer, String> {
                ...
                protected void onPreExecute() {
                    super.onPreExecute();
                    progressDlg = ProgressDialog.show(SearchPerformingplaceActivity.this, "Wait", "Downloading...");
        }
