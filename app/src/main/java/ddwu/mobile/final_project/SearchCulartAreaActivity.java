...
public class SearchCulartAreaActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_culart_area);

        etSido = findViewById(R.id.etSido);
        etGugun = findViewById(R.id.etGuGun);
        ...
        apiAddr = getResources().getString(R.string.api_culart_area);
        ...
        lvCulart.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(SearchCulartAreaActivity.this, CulartDetailActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnSearchCulart: // 사용자로부터 입력받은 키워드로 공연장 검색
                sido = etSido.getText().toString();
                gugun = etGugun.getText().toString();
                try {
                    new SearchCulartAreaAsyncTask().execute(apiAddr + URLEncoder.encode(sido, "UTF-8")
    ...
    class SearchCulartAreaAsyncTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDlg = ProgressDialog.show(SearchCulartAreaActivity.this, "Wait", "Downloading...");
        }
