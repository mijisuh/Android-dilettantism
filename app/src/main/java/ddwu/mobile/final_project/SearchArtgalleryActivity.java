...
public class SearchArtgalleryActivity extends AppCompatActivity {

    public static final String TAG = "SearchPerformingplaceActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        apiAddr = getResources().getString(R.string.api_artgallery);
        ...
        lvPerformingplace.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(SearchArtgalleryActivity.this, CulartPlaceDetailActivity.class);
    ...
    class openapiAsyncTask extends AsyncTask<String, Integer, String> {
                ...
                protected void onPreExecute() {
                    super.onPreExecute();
                    progressDlg = ProgressDialog.show(SearchArtgalleryActivity.this, "Wait", "Downloading...");
        }
